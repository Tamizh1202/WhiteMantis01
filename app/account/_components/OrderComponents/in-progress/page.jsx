      ...
      <div className={styles.container}>
        ...
        <div className={styles.middle}>
          <div className={styles.middleLeft}>
            <p>{order.line_items?.length > 0 ? order.line_items[0].name : "Subscription"}</p>
            ...
            <p>Delivers Every two weeks</p> {/* Placeholder, can be dynamic if subscription data available */}
          </div>
        ...
        <div className={styles.bottom}>
          <p>This delivery is part of your active subscription</p>
        </div>
      </div>
    </div>
  );
