...
export default function Cancelled({ order }) {
      ...
      <div className={styles.container}>
        <div className={styles.top}>
          <div className={styles.left}>
            ...
            <div>
              <p>Cancelled</p>
              <p>on {formatDate(order.date_modified || order.date_created)}</p>
              {/* <p>
                <span style={{ color: "#428B54" }}>Refund Credited:</span> AED
                250 on Dec 19, 2025
               </p> */}
              {/* Note: Refund details need to be parsed from order.refunds if available */}
            </div>
          </div>
