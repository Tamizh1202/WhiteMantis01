            ...
            <div className={styles.Popup}>
                ...
                >
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            onFormChange("phone", "+971" + e.target.value.replace(/^(\+971\s?)/, ""))
                        }
                        style={{
                            border: "none",
                            outline: "none",
                ...
                <div className={styles.Popup} style={{ display: "flex", flexDirection: "row", padding: "0", width: "100%", gap: '0' }}>
                    {ADDRESS_LABELS.map((label) => (
                        <button
                            ...
                            style={{
                                padding: "17px clamp(20px, 5vw, 64px) 20px clamp(20px, 5vw, 64px)",
                                border: "1px solid #2F362A4D",
                                backgroundColor: activeLabelBtn === label ? "#6C7A5F" : "#f8f9f8",
