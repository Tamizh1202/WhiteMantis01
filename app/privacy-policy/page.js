    ...
    <div className={styles.mainPage}>
      ...
      <div className={styles.MainConatiner}>
        ...
        <div className={styles.Desc}>
          ...
                    
          <p>
                        White Mantis Roastery LLC (“White Mantis”, “we”, “us”,
            or “our”) is             committed to safeguarding the privacy of
            individuals whose personal             data we process. This Privacy
            Policy explains how we collect, use,             disclose, and
            protect your personal information when you interact             with
            our website, mobile application, and digital services. Data
                        collection may occur through our mobile application and
            in-store             digital services. Certain website features may
            be informational only             at this stage and may be expanded
            in future updates.           
          </p>
                  
        </div>
        ...
        <div className={styles.Content}>
          ...
                    
          <p>
                        White Mantis Roastery LLC, Dubai, United Arab Emirates,
            is the data             controller responsible for your personal
            data.           
          </p>
                  
        </div>
        ...
        <div className={styles.Content}>
          ...
          <ul>
            ...
                        
            <li>
                            Order Information: Order details, preferences, and
              transaction               history             
            </li>
                        <li>Customers placing in-store or app-based orders</li>
                        
            <li>
                            Technical Information: Device type, IP address, app
              usage data,               browser information             
            </li>
                        
            <li>
                            Payment Information: Processed securely via
              third-party payment               gateways (we do not store card
              details)             
            </li>
                      
          </ul>
        ...
        <div className={styles.Content}>
          ...
          <ul>
                        
            <li>
                            Direct Interactions: When you place orders, create
              an account, or               contact us             
            </li>
                        
            <li>
                            Automated Technologies: Through cookies, app
              analytics, and               similar tools             
            </li>
                        
            <li>
                            Third Parties: Payment processors, delivery
        ...
        <div className={styles.Desc}>
          ...
                    
          <p>
                        This section applies specifically to the White Mantis
            mobile application.           
          </p>
                  
        </div>
        ...
        <div className={styles.Content}>
          ...
          <ul>
                        
            <li>
              Data is shared only with our backend services to provide app
              functionality
            </li>
        ...
        <div className={styles.Content}>
          ...
          <ul>
                        
            <li>
              Users can request account deletion and data removal by contacting
              us
            </li>
                      
          </ul>
        ...
        <div className={styles.Content}>
          ...
          <ul>
            ...
                        
            <li>
              We track referral relationships to credit rewards when a referred
              friend completes their first order
            </li>
                        
            <li>
              Both referrer and friend earn 1 stamp upon successful referral
            </li>
                      
          </ul>
                  
        ...
        <div className={styles.Content}>
          ...
          <ul>
                        
            <li>
              To accurately credit and display your stamps, points and rewards
            </li>
                        <li>To process reward redemptions</li>
                        
            <li>
              To send notifications about reward milestones and expiry (with
              consent)
            </li>
                      
          </ul>
