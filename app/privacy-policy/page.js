...
          <h3>Introduction</h3>
          <p>
            White Mantis Roastery LLC (“White Mantis”, “we”, “us”, or “our”) is
            committed to safeguarding the privacy of individuals whose personal
            data we process. This Privacy Policy explains how we collect, use,
            disclose, and protect your personal information when you interact
            with our website, mobile application, and digital services. Data
            collection may occur through our mobile application and in-store
            digital services. Certain website features may be informational only
            at this stage and may be expanded in future updates.
          </p>
        </div>
...
          <p>
            White Mantis Roastery LLC, Dubai, United Arab Emirates, is the data
...
            </li>
            <li>
              Order Information: Order details, preferences, and transaction
              history
            </li>
            <li>Customers placing in-store or app-based orders</li>
            <li>
              Technical Information: Device type, IP address, app usage data,
              browser information
            </li>
            <li>
...
          <ul>
            <li>
              Direct Interactions: When you place orders, create an account, or
              contact us
            </li>
            <li>
              Automated Technologies: Through cookies, app analytics, and
              similar tools
            </li>
            <li>
              Third Parties: Payment processors, delivery partners, and service
              providers
            </li>
          </ul>
        </div>
...
          <p>Your data may be processed outside your country of residence. We ensure appropriate safeguards are in place to protect your data.</p>
        </div>
        <div className={styles.Content}>
          <h3>Data Security</h3>
...
          <p>We use cookies and similar technologies to enhance user experience and analyze performance. You can manage cookie settings through your browser or device.</p>
        </div>
        <div className={styles.Content}>
