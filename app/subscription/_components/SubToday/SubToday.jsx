      ...
      <div className={styles.main}>
        <div className={styles.MainContainer}>
          ...
          <div className={styles.right}>
            <div className={styles.Card}>
              <div className={styles.CardImageContainer}>
                <div className={styles.CardImage}>
                  <Image src={one} alt="Coffee Beans" />
                </div>
                  ...
                  <div className={styles.CardContentTopBottom}>
                    ...
                    <div className={styles.benefits}>
                      ...
                      <div className={styles.benefitItem}>
                        ...
                        <p>Exclusive access to limited-edition beans.</p>
                      </div>
                      <div className={styles.line}></div>
                      <div className={styles.benefitItem}>
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <g clipPath="url(#clip0_3069_19350)">
                            <path
                        ...
                        <p>Free shipping on all recurring orders.</p>
                      </div>
                      <div className={styles.line}></div>
                      <div className={styles.benefitItem}>
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <g clipPath="url(#clip0_3069_19355)">
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
            ...
            <div className={styles.Card}>
              <div className={styles.CardThreeImageContainer}>
                <div className={styles.CardImageThree}>
                  <Image src={three} alt="Coffee Beans" />
                </div>
                <div className={styles.DealBadge}>
                  <h4>Save upto</h4>
                  <h2>20%</h2>
