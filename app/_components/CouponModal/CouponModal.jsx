...
const CouponModal = () => {
    const { isCouponModalOpen, closeCouponModal, applyCoupon, cartTotals } = useCart();
    ...
    const handleApply = async (code, coupon = null) => {
        if (!code) return;
        if (coupon && !isCouponEligible(coupon)) return;
