...
export const SubscriptionInvoice: React.FC<InvoiceDocumentProps> = ({ data }) => {
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.infoGrid}>
                    ...
                    <View style={styles.infoColLast}>
                        ...
                        {data.metadata.nextBillingDate && (
                            <>
                                <Text style={{ ...styles.label, marginTop: 10, textAlign: "right" }}>Next Billing Date</Text>
                                <Text style={{ ...styles.infoTextBold, textAlign: "right" }}>{data.metadata.nextBillingDate}</Text>
                            </>
                        )}
                    </View>
                </View>
                ...
                <View style={styles.addressGrid}>
                    <View style={styles.addressCol}>
                        ...
                        <Text style={styles.addrBold}>{data.billTo.first_name} {data.billTo.last_name}</Text>
                        ...
                        <Text style={styles.addrText}>{data.billTo.country} — {data.billTo.postcode}</Text>

                        {data.shipTo && (
                            <View style={{ marginTop: 14 }}>
                                <Text style={styles.label}>Ship to</Text>
                                <Text style={styles.addrBold}>{data.shipTo.first_name} {data.shipTo.last_name}</Text>
                                <Text style={styles.addrText}>{data.shipTo.address_1}</Text>
                                <Text style={styles.addrText}>{data.shipTo.city}, {data.shipTo.country} — {data.shipTo.postcode}</Text>
                            </View>
                        )}
                    </View>
