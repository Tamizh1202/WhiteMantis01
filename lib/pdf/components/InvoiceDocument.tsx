    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* ── INFO GRID ──
            ...
            Right block total = 202pt → starts at ~60% of content width
        */}
        ...
        */}
        ...
        {/* ── LINE ITEMS TABLE ──
            Description flex:4  (~37%)
            Frequency   flex:1.4 (~13%)
            Qty         flex:0.8 (~7%)
            Unit Price  flex:2   (~19%)
            Amount      flex:2   (~19%)
        */}
